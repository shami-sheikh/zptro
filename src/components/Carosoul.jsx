...
function Carosoul() {
  ...
  if (loading) return (
    <div className="w-full h-[600px] bg-[#060610] flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-white font-mono tracking-widest text-sm animate-pulse">LOADING...</p>
      </div>
    </div>
  );
  ...
  return (
    ...
    <div className="w-full relative font-serif overflow-hidden bg-[#060610]">
      ...
      <div className="absolute top-0 left-0 right-0 h-14 z-20 flex items-center justify-between px-6 md:px-16"
        style={{ background: "rgba(6,6,16,0.85)", backdropFilter: "blur(12px)" }}
      >
        {/* Brand tag */}
        <div className="flex items-center gap-2">
          <Zap size={16} className="text-red-500" fill="currentColor" />
          <span className="text-white text-xs font-mono tracking-[0.3em] uppercase">Zaptro Store</span>
        </div>
            ...
            {products.map((_, i) => (
              <div
                ...
                className={`h-[3px] rounded-full cursor-pointer transition-all duration-500 ${
                  i === activeIndex ? "w-8 bg-red-500" : "w-3 bg-white/20"
                }`}
              />
            ))}
          </div> */}
        ...
        <div className="flex gap-2">
          ...
          >
            <ArrowLeft size={16} className="text-white/50 group-hover:text-red-400 transition-colors" strokeWidth={2} />
          </button>
          <button
            onClick={() => swiperRef.current?.swiper.slideNext()}
            className="group w-9 h-9 border border-white/10 hover:border-red-500 rounded flex items-center justify-center transition-all duration-300 hover:bg-red-500/10"
          >
            <ArrowRight size={16} className="text-white/50 group-hover:text-red-400 transition-colors" strokeWidth={2} />
          </button>
        </div>
      </div>
            ...
            <div className="relative w-full min-h-[600px] md:min-h-[680px] flex items-center overflow-hidden">
              ...
              <div className="absolute inset-0 z-0">
                <div
                  ...
                  style={{ background: "radial-gradient(circle, #ff003c, transparent)" }}
                />
                <div
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, transparent 40%, rgba(255,0,60,0.3) 100%)",
              ...
              <div className="flex flex-col md:hidden bg-[#060610] w-full items-center pt-20 pb-10 px-6 gap-6 z-10">
                ...
                <div className="relative">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: "0 0 60px rgba(255,0,60,0.15), inset 0 0 60px rgba(124,58,237,0.1)",
                ...
                <div className="text-center space-y-3">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <button className="flex items-center gap-2 bg-red-500 hover:bg-red-600 active:scale-95 text-white text-sm font-bold px-5 py-2.5 rounded transition-all duration-200">
                      <ShoppingBag size={14} />
                      Buy Now
                    </button>
                  </div>
              ...
              <div className="hidden md:flex w-full max-w-6xl mx-auto px-16 items-center justify-between gap-10 pt-14 pb-10 z-10">
                ...
                <div className="flex-1 space-y-7 max-w-[520px]">
                  ...
                  <div className="flex items-center gap-6">
                    <div>
                      <p className="text-white/30 text-xs font-mono uppercase tracking-widest mb-1">Price</p>
                      <span
                ...
                <div className="relative flex items-center justify-center flex-shrink-0">
                  ...
                  <div
                    ...
                    style={{ background: "radial-gradient(circle, rgba(255,0,60,0.6), rgba(124,58,237,0.4))" }}
                  />
                  ...
                  <div
                    ...
                    style={{
                      background: "radial-gradient(circle at 40% 40%, rgba(124,58,237,0.12), rgba(255,0,60,0.06), transparent)",
                      border: "1px solid rgba(255,255,255,0.04)",
                      boxShadow: "0 0 80px rgba(255,0,60,0.12), inset 0 0 80px rgba(124,58,237,0.06)"
                    }}
                  >
                    <img
                      src={product.image}
